...
class employeeSearch extends React.Component {
	...
	searchEmployee = () => {
		const emp = {
			...
			ageFrom:  dateUtils.ageToBirthday(this.state.ageFrom),
			ageTo: dateUtils.ageToBirthday(this.state.ageTo),
			...
			intoCompanyYearAndMonthFrom:  dateUtils.formateDate(this.state.intoCompanyYearAndMonthFrom,false),
			intoCompanyYearAndMonthTo:  dateUtils.formateDate(this.state.intoCompanyYearAndMonthTo,false),
