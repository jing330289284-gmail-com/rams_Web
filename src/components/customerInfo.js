            ...
            <div>
                                    ...
                                    renderInput={(params) => (
                                        <div ref={params.InputProps.ref}>
                                            <input placeholder="  例：富士通" type="text" {...params.inputProps}
                                                style={{ width: 234, height: 31, borderColor: "#ced4da", borderWidth: 1, borderStyle: "solid", fontSize: ".875rem", color: "#495057" }} />
                                        </div>
                                    )}
                                />
                        </InputGroup>
                ...
                <Row>
                    ...
                    headerStyle={{ background: '#5599FF' }} striped hover condensed>
                        ...
                        <TableHeaderColumn row='0' rowSpan='2' dataField='responsiblePerson' tdStyle={{ padding: '.45em' }} headerAlign='center' dataAlign='center' width="130">名前</TableHeaderColumn>
