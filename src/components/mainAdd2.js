							...
							<Row>
								...
								<Col sm={3}>
									<InputGroup size="sm" className="mb-3">
										...
										<FormControl id="inlineFormInputGroup" placeholder="社内メール" value={employeeNo} autoComplete="off"
											onChange={this.valueChange} size="sm" name="employeeNo" />
									</InputGroup>
								</Col>
							</Row>
						...
						<Row>
							<Col sm={3}>
								<InputGroup size="sm" className="mb-3">
									...
									<FormControl id="inlineFormInputGroup" placeholder="卒業学校" value={employeeNo} autoComplete="off"
										onChange={this.valueChange} size="sm" name="employeeNo" />
								</InputGroup>
							</Col>
							<Col sm={3}>
						...
						<Row>
							<Col sm={3}>
								<InputGroup size="sm" className="mb-3">
									...
									<FormControl id="inlineFormInputGroup" placeholder="履歴書" value={employeeNo} autoComplete="off"
										onChange={this.valueChange} size="sm" name="employeeNo" />
								</InputGroup>
							</Col>
							<Col sm={3}>
