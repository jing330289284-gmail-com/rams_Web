...
import { getStocks, matchStocks } from './dataTest';
import './dataTest.css';
...
class messegeAlert extends React.Component {
	...
	render() {
		const { employeeNo, employeeFristName, developmentLanguageNo, arr } = this.state;
					...
					<Form onSubmit={this.state.employeeNo ? this.updateBook : this.submitBook} onReset={this.resetBook} id="bookFormID">
						<Card.Body>
							<Form.Row>
								...
								<Form.Group as={Col} controlId="formGridEmployeeFristName">
									<input type="text" ref='input' onChange={this.handleChanges} className='form-control' placeholder='百度搜索框' />
