 ...
 * 報告書送信お客確認画面
 */
class sendRepotConfirm extends React.Component {
				...
				<Row style={{ padding: "10px" }}>
					...
					<Col sm={3}>
						<InputGroup size="sm" className="mb-3">
							...
							<textarea ref={(textarea) => this.textArea = textarea} maxLength="100" value = {this.state.mailTitle}  id="mailTitle" name="mailTitle" 
...
export default sendRepotConfirm;