							...
							<Row>
								<Col sm={12}>
									<BootstrapTable selectRow={selectRow} data={this.state.salesPointData} ref='table' pagination={true} options={this.options} headerStyle={{ background: '#5599FF' }} striped hover condensed>
										...
										<TableHeaderColumn dataField='customerName' tdStyle={{ padding: '.45em' }} width='160'>お客様</TableHeaderColumn>
										...
										<TableHeaderColumn dataField='specialsalesPointCondition' tdStyle={{ padding: '.45em' }} width='170' dataFormat={this.specialPointStatusFormat.bind(this)}>特別ポイント理由</TableHeaderColumn>
